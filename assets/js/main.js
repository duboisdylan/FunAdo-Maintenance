(function($){
	...
	jQuery(document).on('ready', function () {
        ...
        // Count Time 
        function makeTimer() {
            var endTime = new Date("May 9, 2021 17:00:00 PDT");			
		...
		$(".newsletter-form").ajaxChimp({
			url: "https://xx.us20.list-manage.com/subscribe/post?u=60e1ffe2e8a68ce1204cd39a5&amp;id=42d6d188d9", // Your url MailChimp
